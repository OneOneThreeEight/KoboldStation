...
/obj/random/loot
	...
	problist = list(
		...
		/obj/item/weapon/banhammer = 0.05,
		...
		/obj/item/weapon/grenade/chem_grenade/cleaner = 0.1,
		/obj/item/weapon/grenade/smokebomb = 0.05, //We /tg/ now.
		...
		/obj/item/weapon/reagent_containers/extinguisher_refill/filled = 0.5,
		...
		/obj/item/weapon/storage/wallet/random/ = 0.1,
...
/obj/random/junk
	...
	problist = list(
		...
		/obj/item/weapon/flame/lighter/random = 0.25,
		/obj/item/weapon/lipstick/random = 0.25,
		/obj/item/weapon/reagent_containers/glass/beaker/vial/random = 0.1,
		/obj/item/weapon/towel/random = 0.1,
