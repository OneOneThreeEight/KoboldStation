	...
	switch(mission_level)
		if(REPRESENTATIVE_MISSION_HIGH)
			objective = pick("Assist your contractor in smuggling [rand(1,4)] items of value",
							"Collect evidence of kobold leaders being unfair or oppressive against your contractors to be used as leverage in future talks")
		if(REPRESENTATIVE_MISSION_MEDIUM)
			objective = pick("Convince [rand(1,3)] kobold supporters to join your own company",
							"Have [rand(1,3)] of your contractors write down their grievances with the kobolds, and present the report to the UKS.")
		else
