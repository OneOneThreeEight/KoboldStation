...
/obj/structure/bonfire/process()
	...
	check_light()
	heat()
	playsound(src.loc, 'sound/effects/fireplace.ogg', 50, 1, -3)
...
/obj/structure/bonfire/fireplace
	...
	icon = 'icons/kobold/fireplace.dmi'
...
/obj/machinery/appliance/bonfire
	name = "cooking fire" // because it could also be something other than a bonfire, like a stove etc. and i don't want to waste time overriding procs just for this
	desc = "Nice and hot."
	cook_type = "roasted"
